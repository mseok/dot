...
Academic mode activates automatically when the input contains LaTeX markup or comes from a `.tex` file. You can also trigger it explicitly:
...
In academic mode, the skill preserves standard academic hedging, formal tone, legitimate technical vocabulary, and journal heading conventions — while still catching AI slop like significance inflation, promotional language, and filler phrases.
...
- **2.2.0** - Added academic mode (auto-detects LaTeX, preserves hedging/formal tone/technical vocabulary)
